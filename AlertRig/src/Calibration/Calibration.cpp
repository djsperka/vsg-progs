...
void init_triggers()
{
	...
	triggers.addTrigger(new PageTrigger("1", 0x3e, 0x16, 0xff, 0x2, 1));
	triggers.addTrigger(new PageTrigger("2", 0x3e, 0x1a, 0xff, 0x2, 2));
	triggers.addTrigger(new PageTrigger("3", 0x3e, 0x1e, 0xff, 0x2, 3));
	triggers.addTrigger(new PageTrigger("4", 0x3e, 0x26, 0xff, 0x2, 4));
	triggers.addTrigger(new PageTrigger("5", 0x3e, 0x2a, 0xff, 0x2, 5));
	triggers.addTrigger(new PageTrigger("6", 0x3e, 0x2e, 0xff, 0x2, 6));
	triggers.addTrigger(new PageTrigger("7", 0x3e, 0x36, 0xff, 0x2, 7));
	triggers.addTrigger(new PageTrigger("8", 0x3e, 0x3a, 0xff, 0x2, 8));
	triggers.addTrigger(new PageTrigger("9", 0x3e, 0x3e, 0xff, 0x2, 9));
	triggers.addTrigger(new QuitTrigger("q", 0x40, 0x40, 0xff, 0x2, 0));
}

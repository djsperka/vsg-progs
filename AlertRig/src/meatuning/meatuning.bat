...
rem C:\work\AlertRig\bin\meatuning -t 1.0 -b gray -d 500 -g 0,0,200.0,200.0,100,.3,3.00,90.0,b,s,e -O 0,60,120,180,240,300,360

rem try two in a row
C:\work\AlertRig\bin\meatuning -t 1.0 -b gray -d 500 -g 0,0,0,0,100,.3,0.00,90.0,b,s,e -X 0,90,180,270 -x 0.25
rem C:\work\AlertRig\bin\meatuning -t 1.0 -b gray -d 500 -g 0,0,0,0,100,.3,3.00,90.0,b,s,e -T 0.1,.5,1,2,3

...
void FXMultiGStimSet::add_dot(const ARDotSpec& dot)
{
	m_dots.push_back(new ARDotSpec(dot));
	return;
}

void FXMultiGStimSet::add_dot(const vector<alert::ARFixationPointSpec>& dots)
{
	ARDotSpec* pspec = new ARDotSpec();
	pspec->setMulti(dots);
...
{
	return init(pages, num_stim_pages);
}
...
int FixptGratingStimSet::handle_trigger(const std::string &s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int FixptMultiGratingStimSet::handle_trigger(const std::string &s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int ContrastStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int TFStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int SFStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int OrientationStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int AreaStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int AnnulusStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int InnerDiameterStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int PositionStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int DanishStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int FlashStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int CRGStimSet::handle_trigger(const std::string& s, const std::string&)
{
...
int CBarStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{
...
int CounterphaseStimSet::handle_trigger(const std::string& s, const std::string&)
{
	int status = 0;
	if (s == "F")
	{

========================================================================
		ActiveX Control DLL : ACTIVEXSVR
========================================================================

ControlWizard has created this project for your ACTIVEXSVR ActiveX Control
...
that make up your ACTIVEXSVR ActiveX Control DLL.
...
ActiveXSvrCtl.h
	This file contains the declaration of the CActiveXSvrCtrl C++ class.

ActiveXSvrCtl.cpp
	This file contains the implementation of the CActiveXSvrCtrl C++ class.

ActiveXSvrPpg.h
	This file contains the declaration of the CActiveXSvrPropPage C++ class.

ActiveXSvrPpg.cpp
	This file contains the implementation of the CActiveXSvrPropPage C++ class.

ActiveXSvrCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CActiveXSvrCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ActiveXSvr.rc.

...
rem ..\..\bin\fixstim -a -v -d 500 -s 0,0,5,5,100,.2,1,45,b,s,e -O 0,45,90,135,180

rem area tuning curve, ascii triggers
rem ..\..\bin\fixstim -a -v -d 500 -f 0,0,.5,red -s 0,0,5,5,100,.2,1,45,b,s,e -A 1,2,3,4,5
rem ..\..\bin\fixstim -a -v -d 500 -s 0,0,5,5,100,.2,1,45,b,s,e -A 1,2,3,4,5

rem inner diameter tuning curve, ascii triggers
..\..\bin\fixstim -a -v -d 500 -f 0,0,.5,red -s 0,0,8,8,100,.2,1,45,b,s,e -I 1,2,3,4,5
...
rem POSITION tuning curve, ascii triggers
rem ..\..\bin\fixstim -a -v -d 500 -f 0,0,.5,red -s 0,0,5,5,100,.2,1,45,b,s,e -Z 0,0,1,1,2,2,3,3
rem ..\..\bin\fixstim -a -v -d 500 -s 0,0,5,5,100,.2,1,45,b,s,e -Z 0,0,1,1,2,2,3,3
...
rem ..\..\bin\fixstim -a -v -d 500 -s 0,0,5,5,100,.2,1,45,b,s,e -e f=d:/work/AlertRig/src/fixstim/sequence-test.txt -L 40
rem ..\..\bin\fixstim -a -v -d 500 -f 0,0,1,(255/255/0) -s 0,0,5,5,100,.2,1,45,b,s,e -e 012012012 -L 40,red,green,blue
...
rem triggered display. Load fixstim.pls file (make sure 0x80 sample key available)
rem ..\..\bin\fixstim -v -d 500 -f 0,0,1,red -g 0,0,5,5,100,.2,1,45,b,s,e -V
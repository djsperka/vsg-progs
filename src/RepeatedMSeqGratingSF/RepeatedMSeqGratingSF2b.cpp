...
//each other
	...
	for (i= 1; i<=200; i++)
	{
		...
		TempBuffer2[0].Buffer[i].a =.5;
		TempBuffer2[0].Buffer[i].b =.5;
		TempBuffer2[0].Buffer[i].c =.5;	
		TempBuffer2[1].Buffer[i].a =(cos(2*Pi*(index/200)+0)/2)+.5;
		TempBuffer2[1].Buffer[i].b =(cos(2*Pi*(index/200)+0)/2)+.5;
		TempBuffer2[1].Buffer[i].c =(cos(2*Pi*(index/200)+0)/2)+.5;
		TempBuffer2[2].Buffer[i].a =(cos(2*Pi*(index/200)+Pi)/2)+.5;
		TempBuffer2[2].Buffer[i].b =(cos(2*Pi*(index/200)+Pi)/2)+.5;
		TempBuffer2[2].Buffer[i].c =(cos(2*Pi*(index/200)+Pi)/2)+.5;
		TempBuffer2[3].Buffer[i].a =(cos(2*Pi*(index/200)+0)/2)+.5;
		TempBuffer2[3].Buffer[i].b =(cos(2*Pi*(index/200)+0)/2)+.5;
		TempBuffer2[3].Buffer[i].c =(cos(2*Pi*(index/200)+0)/2)+.5;
		TempBuffer2[4].Buffer[i].a =(cos(2*Pi*(index/200)+Pi)/2)+.5;
		TempBuffer2[4].Buffer[i].b =(cos(2*Pi*(index/200)+Pi)/2)+.5;
		TempBuffer2[4].Buffer[i].c =(cos(2*Pi*(index/200)+Pi)/2)+.5;
		index=index+1;
	}	
...
for (i=0; i<=NumTerms; i++)
{
	...
	if (RN[i]<.5)
	{
		...
		vsgLUTBUFFERWrite(NumTerms+2+i, (VSGLUTBUFFER*)&TempBuffer2[3].Buffer);
	...
	else
	{
		RN[i] = 0;
		fprintf(RandFile,"%f\n",RN[i]);
		vsgLUTBUFFERWrite(i+1, (VSGLUTBUFFER*)&TempBuffer2[2].Buffer);
		vsgLUTBUFFERWrite(NumTerms+2+i, (VSGLUTBUFFER*)&TempBuffer2[4].Buffer);
	}
}
